        ...
        <ul className="list-group list-group-horizontal d-flex justify-content-center">
            ...
            <li className="list-group-item bg-transparent border-0">
                <ul className="list-group d-flex align-items-start p-0">
                    ...
                    <small className="text-white" style={{fontSize: "clamp(0.7rem, 5vw, 0.9rem)", fontWeight: "600"}}>
                        test_username1
                    </small>
                    <small style={{color: "#c9c9c9", fontSize: "clamp(0.5rem, 5vw, 0.75rem)"}}>&nbsp;&nbsp;5:06 PM</small>
                    </li>
                    <li className="list-group-item bg-transparent border-0 m-0 p-0">
            ...
            {/* 3-dot menu */}
            <li className="list-group-item bg-transparent border-0">
            <button className="list-group-item-action bg-transparent border-0" id="menu">
